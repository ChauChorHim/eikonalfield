...
def create_nerf(args):
    ...
    # Load checkpoints
    os.makedirs(os.path.join(basedir, expname,args.model_path), exist_ok=True)                    
...
def config_parser():
    ...
    parser.add_argument("--expname", default='Ball',type=str, 
                        help='experiment name')
    parser.add_argument("--basedir", type=str, default='logs', 
                        help='where to store ckpts and logs')
    parser.add_argument("--datadir", type=str, default='data\\Ball', 
    ...
    parser.add_argument("--lrate", type=float, default=5e-4, 
                        help='learning rate')
    parser.add_argument("--lrate_decay", type=int, default=150, 
